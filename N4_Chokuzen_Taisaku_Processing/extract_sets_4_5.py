...
def main():
    pages = {
        "set4_vocab": [f"page_{i:03d}.jpg" for i in range(26, 32)],
        "set4_grammar": [f"page_{i:03d}.jpg" for i in range(88, 94)],
        "set5_vocab": [f"page_{i:03d}.jpg" for i in range(32, 38)],
        "set5_grammar": [f"page_{i:03d}.jpg" for i in range(94, 100)],
    }
    ...
    with open(r"D:\sudip_software\nihongo_playground\N4_Chokuzen_Taisaku_Processing\raw_gemini_4_5.json", "w", encoding="utf-8") as out:
