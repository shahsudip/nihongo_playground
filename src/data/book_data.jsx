    ...
    "chapters": [
      {
        ...
        "type": "short-passage",
        "description": "日時を正しく読もう！ - Try to read dates and times correctly!",
        "passages": []
      },
      {
        "id": "week1-day2",
        "title": "Week 1 - Day 2: 案内② (Notices 2)",
        "type": "short-passage",
        "description": "条件を正しく読もう！ - Understand conditions and requirements in notices.",
        "passages": []
      },
      {
        "id": "week1-day3",
        "title": "Week 1 - Day 3: 案内③ (Notices 3)",
        "type": "short-passage",
        "description": "注目する部分を見つけよう！ - Scan advertisements and flyers efficiently.",
        "passages": []
      },
      {
        "id": "week1-day4",
        "title": "Week 1 - Day 4: 案内④ (Notices 4)",
        "type": "short-passage",
        "description": "注意書きを読もう！ - Read cautions, rules, and warnings carefully.",
        "passages": []
      },
      {
        "id": "week1-day5",
        "title": "Week 1 - Day 5: 案内⑤ (Letters/Mails)",
        "type": "short-passage",
        "description": "手紙・メールを読もう！ - Comprehend notices delivered via letters and emails.",
        "passages": []
      },
      {
        "id": "week1-day6",
        "title": "Week 1 - Day 6: 案内⑥ (Tables/Charts)",
        "type": "short-passage",
        "description": "表やグラフを読もう！ - Interpret tables, schedules, and fee structures.",
        "passages": []
      },
      {
        "id": "week1-day7",
        "title": "Week 1 - Day 7: 実戦問題 (Review 1)",
        "type": "short-passage",
        "description": "第1週のまとめ・実戦問題 - Comprehensive Week 1 review practice test.",
        "passages": []
      },
      {
        "id": "week2-day1",
        "title": "Week 2 - Day 1: 掲示① (Signs 1)",
        "type": "short-passage",
        "description": "掲示や標識を読もう - Signboards and public notices.",
        "passages": []
      },
      {
        "id": "week2-day2",
        "title": "Week 2 - Day 2: 掲示② (Signs 2)",
        "type": "short-passage",
        "description": "注意・禁止の表現 - Cautionary notices.",
        "passages": []
      },
      {
        "id": "week2-day3",
        "title": "Week 2 - Day 3: 広告① (Advertisements 1)",
        "type": "short-passage",
        "description": "チラシや広告の読み取り - Flyers and ads.",
        "passages": []
      },
      {
        "id": "week2-day4",
        "title": "Week 2 - Day 4: 広告② (Advertisements 2)",
        "type": "short-passage",
        "description": "求人・イベント案内 - Job listings and event guides.",
        "passages": []
      },
      {
        "id": "week2-day5",
        "title": "Week 2 - Day 5: 説明書 (Instructions)",
        "type": "short-passage",
        "description": "使い方の説明を読もう - Reading manuals and instructions.",
        "passages": []
      },
      {
        "id": "week2-day6",
        "title": "Week 2 - Day 6: グラフ・表 (Charts)",
        "type": "short-passage",
        "description": "データの読み取り - Reading statistical charts.",
        "passages": []
      },
      {
        "id": "week2-day7",
        "title": "Week 2 - Day 7: 実戦問題 (Review 2)",
        "type": "short-passage",
        "description": "第2週のまとめ・実戦問題 - Comprehensive Week 2 review practice test.",
        "passages": []
      },
      {
        "id": "week3-day1",
        "title": "Week 3 - Day 1: メール① (Emails 1)",
        "type": "short-passage",
        "description": "日常のメールを読もう - Daily email communications.",
        "passages": []
      },
      {
        "id": "week3-day2",
        "title": "Week 3 - Day 2: メール② (Emails 2)",
        "type": "short-passage",
        "description": "依頼・確認メール - Requests and confirmations.",
        "passages": []
      },
      {
        "id": "week3-day3",
        "title": "Week 3 - Day 3: 手紙・はがき① (Letters 1)",
        "type": "short-passage",
        "description": "お礼や近況の手紙 - Thank-you cards and updates.",
        "passages": []
      },
      {
        "id": "week3-day4",
        "title": "Week 3 - Day 4: 手紙・はがき② (Letters 2)",
        "type": "short-passage",
        "description": "季節の挨拶と用件 - Seasonal greetings and main points.",
        "passages": []
      },
      {
        "id": "week3-day5",
        "title": "Week 3 - Day 5: 手紙・はがき③ (Letters 3)",
        "type": "short-passage",
        "description": "案内状・招待状 - Invitations and notifications.",
        "passages": []
      },
      {
        "id": "week3-day6",
        "title": "Week 3 - Day 6: FAX・ビジネス (Business Letters)",
        "type": "short-passage",
        "description": "仕事のやり取り - Business letters and faxes.",
        "passages": []
      },
      {
        "id": "week3-day7",
        "title": "Week 3 - Day 7: 実戦問題 (Review 3)",
        "type": "short-passage",
        "description": "第3週のまとめ・実戦問題 - Comprehensive Week 3 review practice test.",
        "passages": []
      },
      {
        "id": "week4-day1",
        "title": "Week 4 - Day 1: 短文① (Short Passages 1)",
        "type": "short-passage",
        "description": "筆者の主張をつかもう - Identify the main thesis.",
        "passages": []
      },
      {
        "id": "week4-day2",
        "title": "Week 4 - Day 2: 短文② (Short Passages 2)",
        "type": "short-passage",
        "description": "理由・原因を捉えよう - Identify cause and reasons.",
        "passages": []
      },
      {
        "id": "week4-day3",
        "title": "Week 4 - Day 3: 短文③ (Short Passages 3)",
        "type": "short-passage",
        "description": "対比の文章 - Comparing and contrasting points.",
        "passages": []
      },
      {
        "id": "week4-day4",
        "title": "Week 4 - Day 4: 短文④ (Short Passages 4)",
        "type": "short-passage",
        "description": "指示語の指す内容 - Contextual references (これ・それ・あれ).",
        "passages": []
      },
      {
        "id": "week4-day5",
        "title": "Week 4 - Day 5: 短文⑤ (Short Passages 5)",
        "type": "short-passage",
        "description": "感情や考えの表現 - Expressions of thoughts and emotions.",
        "passages": []
      },
      {
        "id": "week4-day6",
        "title": "Week 4 - Day 6: 短文⑥ (Short Passages 6)",
        "type": "short-passage",
        "description": "説明文の展開 - Flow of explanatory essays.",
        "passages": []
      },
      {
        "id": "week4-day7",
        "title": "Week 4 - Day 7: 実戦問題 (Review 4)",
        "type": "short-passage",
        "description": "第4週のまとめ・実戦問題 - Comprehensive Week 4 review practice test.",
        "passages": []
      },
      {
        "id": "week5-day1",
        "title": "Week 5 - Day 1: 中文① (Medium Passages 1)",
        "type": "short-passage",
        "description": "段落ごとの要点 - Paragraph main points.",
        "passages": []
      },
      {
        "id": "week5-day2",
        "title": "Week 5 - Day 2: 中文② (Medium Passages 2)",
        "type": "short-passage",
        "description": "論理の流れをつかむ - Logical progression.",
        "passages": []
      },
      {
        "id": "week5-day3",
        "title": "Week 5 - Day 3: 中文③ (Medium Passages 3)",
        "type": "short-passage",
        "description": "意見と事実の区別 - Distinguishing opinion vs. fact.",
        "passages": []
      },
      {
        "id": "week5-day4",
        "title": "Week 5 - Day 4: 中文④ (Medium Passages 4)",
        "type": "short-passage",
        "description": "具体例とまとめ - Concrete examples and synthesis.",
        "passages": []
      },
      {
        "id": "week5-day5",
        "title": "Week 5 - Day 5: 中文⑤ (Medium Passages 5)",
        "type": "short-passage",
        "description": "エッセイ・随筆 - Personal essays and reflections.",
        "passages": []
      },
      {
        "id": "week5-day6",
        "title": "Week 5 - Day 6: 中文⑥ (Medium Passages 6)",
        "type": "short-passage",
        "description": "解説・論説文 - Commentaries and editorials.",
        "passages": []
      },
      {
        "id": "week5-day7",
        "title": "Week 5 - Day 7: 実戦問題 (Review 5)",
        "type": "short-passage",
        "description": "第5週のまとめ・実戦問題 - Comprehensive Week 5 review practice test.",
        "passages": []
      },
      {
        "id": "week6-day1",
        "title": "Week 6 - Day 1: 長文・情報検索① (Long Passages / Info Search 1)",
        "type": "short-passage",
        "description": "長文の構造を把握する - Long passage structural analysis.",
        "passages": []
      },
      {
        "id": "week6-day2",
        "title": "Week 6 - Day 2: 長文・情報検索② (Long Passages / Info Search 2)",
        "type": "short-passage",
        "description": "筆者の最終的な主張 - Author's overarching conclusion.",
        "passages": []
      },
      {
        "id": "week6-day3",
        "title": "Week 6 - Day 3: 長文・情報検索③ (Long Passages / Info Search 3)",
        "type": "short-passage",
        "description": "複数の情報を照合する - Cross-referencing multi-part info.",
        "passages": []
      },
      {
        "id": "week6-day4",
        "title": "Week 6 - Day 4: 長文・情報検索④ (Long Passages / Info Search 4)",
        "type": "short-passage",
        "description": "条件に合う情報の特定 - Matching specific conditions.",
        "passages": []
      },
      {
        "id": "week6-day5",
        "title": "Week 6 - Day 5: 長文・情報検索⑤ (Long Passages / Info Search 5)",
        "type": "short-passage",
        "description": "実用的な文書検索 - Real-world practical information lookup.",
        "passages": []
      },
      {
        "id": "week6-day6",
        "title": "Week 6 - Day 6: 長文・情報検索⑥ (Long Passages / Info Search 6)",
        "type": "short-passage",
        "description": "総合実践演習 - Comprehensive reading practice.",
        "passages": []
      },
      {
        "id": "week6-day7",
        "title": "Week 6 - Day 7: 模擬試験 (Final Mock Exam)",
        "type": "short-passage",
        "description": "総まとめ・模擬テスト - Full final mock test for JLPT N3 Dokkai.",
        "passages": []
      }
    ]
  },
