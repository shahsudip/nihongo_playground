    ...
    <div className="ps-details-container animate-fade-in">
      <nav aria-label="Breadcrumb" className="ps-breadcrumb">
        <ol className="flex flex-wrap items-center gap-1 text-sm">
          ...
          <li className="flex items-center">
            <span className="mx-2 breadcrumb-separator">/</span>
            <Link to="/practice-sets" className="breadcrumb-link">N3 Chokuzen Taisaku</Link>
          </li>
          <li className="flex items-center">
            <span className="mx-2 breadcrumb-separator">/</span>
      ...
      <header className="ps-details-header">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="ps-subtitle-text">JLPT N3 Chokuzen Taisaku • {vocabKanjiTotal + grammarTotal} questions</p>
          </div>
        </div>
      </header>
...
export default N3PracticeSetDetailsPage;
