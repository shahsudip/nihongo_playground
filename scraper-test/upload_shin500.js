...
const jsonPath = path.join(__dirname, 'shin500.json');
if (!fs.existsSync(jsonPath)) {
  console.error(`❌ ERROR: Could not find shin500.json at ${jsonPath}`);
  console.error('Please run "python scraper-test/generate_book_json.py" first to generate the file.');
  process.exit(1);
}
