...
if (match) {
  ...
  books.forEach(b => {
    b.chapters.forEach(c => {
      c.passages?.forEach(p => {
        if (p.title && p.title.includes('問題17')) {
          p.passageText = `<div class="font-sans text-sm md:text-base text-gray-800 dark:text-gray-200 leading-loose">
  ...
  <div class="mb-4">
    ...
    <div class="flex justify-between items-start mb-6">
      <div class="flex-grow pr-4 space-y-4">
        <div class="flex"><span class="mr-2">1.</span><p>まず、とり肉を一口大<span class="text-xs">(注1)</span>に切り、たまねぎをうす切りにします。<br/>ボールにたまごを割って混ぜておきます。</p></div>
        <div class="flex"><span class="mr-2">2.</span><p>なべにだし汁<span class="text-xs">(注2)</span>、みりん、酒、しょうゆ、<br/>さとうを入れて火にかけます。</p></div>
        <div class="flex"><span class="mr-2">3.</span><p>沸騰したら、たまねぎ、とり肉を入れて、<br/>中火～弱火で煮ます。</p></div>
        <div class="flex"><span class="mr-2">4.</span><p>とり肉が煮えたら、たまごを回し入れます<span class="text-xs">(注3)</span>。<br/>固まり始めたら、火をとめます。</p></div>
  ...
  <div class="mb-6">
    ...
    <p>最後にたまごを入れたら、あまり混ぜないこと。そして長く煮ないこと。</p>
          ...
          p.passageNotes = `<div class="text-sm">
