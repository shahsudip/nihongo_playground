...
if (match) {
  ...
  <!-- Pie Chart Container -->
  <div class="border-2 border-gray-400 p-6 mb-2 max-w-lg mx-auto bg-white relative h-[360px] md:h-[420px] flex items-center justify-center">
    <h3 class="absolute top-4 w-full text-center font-bold text-lg tracking-widest">アルバイトの目的</h3>
    ...
    <svg viewBox="-100 -100 200 200" class="w-48 h-48 md:w-56 md:h-56 transform -rotate-90">
      ...
      <!-- Slice 1: 生活費 (0 to 32.8%) -->
      <!-- Slice 2: 学生生活 (32.8% to 65.2%) -->
      <!-- Slice 3: 社会経験 (65.2% to 89.4%) -->
      <!-- Path: move to center, line to edge, arc, line to center -->
      <!-- 65.2% to 89.4% is 234.7deg to 321.8deg. Since rotate-90, we calculate directly in standard coordinates and SVG transforms it. -->
      <!-- Just use stroke-dasharray for simplicity! Circle circumference = 2 * PI * 50 = 314.159. We use r=50 and stroke-width=100 -->
      <circle r="50" cx="0" cy="0" fill="transparent" stroke="#9ca3af" stroke-width="100" stroke-dasharray="76.0 314.2" stroke-dashoffset="-204.8"></circle> <!-- 社会経験: 24.2% of 314.159 = 76.0, offset = 65.2% of 314.159 = -204.8 -->
      
      <!-- その他: 4.5% (89.4% to 93.9%) -->
    ...
    <!-- Inside labels -->
    <div class="absolute font-bold text-xs md:text-sm text-center" style="top: 45%; left: 63%;">生活費を稼<br/>ぐため<br/>32.8%</div>
    <div class="absolute font-bold text-xs md:text-sm text-center" style="top: 70%; left: 45%;">学生生活を<br/>楽しむため<br/>32.4%</div>
    <div class="absolute font-bold text-xs md:text-sm text-white text-center" style="top: 55%; left: 25%;">社会経験<br/>のため<br/>24.2%</div>
    
    <!-- Outside labels with drawing lines -->
    <!-- 無回答 -->
    <div class="absolute font-bold text-xs md:text-sm text-center" style="top: 15%; left: 15%;">無回答<br/>5.1%</div>
    <div class="absolute border-t border-black w-12" style="top: 25%; left: 25%; transform: rotate(20deg);"></div>
    
    <!-- その他 -->
    <div class="absolute font-bold text-xs md:text-sm text-center" style="top: 25%; left: 40%;">その他<br/>4.5%</div>
    <div class="absolute border-t border-black w-8" style="top: 32%; left: 46%; transform: rotate(70deg);"></div>
    
    <!-- 勉学費 -->
    <div class="absolute font-bold text-xs md:text-sm text-center" style="top: 32%; left: 10%;">勉学費を稼<br/>ぐため<br/>1.0%</div>
  ...
  console.log('Fixed Mondai 27 pie chart!');
}
